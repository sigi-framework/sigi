...
**Note:** Version bump only for package @stringke/sigi-react-router
...
- **react-router:** missing @stringke/sigi-{di,types} dependencies ([6f50a97](https://github.com/sigi-framework/sigi/commit/6f50a9792a2acf3b604c1a736861ea2d1009b206))
